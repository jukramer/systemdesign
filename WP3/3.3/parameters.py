...
S_h = 0             # horizontal tail area [m^2]
V_D = 0             # design dive speed [m/s]
Lambda_12_h = 0     # semi-chord sweep angle horizontal tail [rad]

S_v = 0             # vertical tail area [m^2]
z_h = 0             # distance from vert.tail root to where ht is mounted on the v.t.
b_v = 0             # vertical tail span [m]
